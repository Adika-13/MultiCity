                    ...
                    child: Transform(
                        ...
                        child: Column(children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text(
                              Utils.getString(context,
                                  'dashboard__latest_city_description'),
                              textAlign: TextAlign.start,
                              style: Theme.of(context).textTheme.bodyText1,
                            ),
                          ),
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    if (cityProvider.cityList.status ==
                                      ...
                                      final City city =
                                          cityProvider.cityList.data[index];

                                      return CityHorizontalListItem(
                                        coreTagKey:
                                            cityProvider.hashCode.toString() +
                                                city.id, //'latest',
                                        city: city,
                                        onTap: () async {
                                          cityProvider.replaceCityInfoData(
                                            cityProvider
                                                .cityList.data[index].id,
                                            cityProvider
                                                .cityList.data[index].name,
                                            cityProvider
                                                .cityList.data[index].lat,
                                            cityProvider
                                                .cityList.data[index].lng,
                                          );
                                          Navigator.pushNamed(
                                            context,
                                            RoutePaths.itemHome,
                                  ...
                                  Container(
                                      ...
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (BuildContext context,
                                              int index) {
                                            if (provider.recommandedCityList
                                                    .status ==
                                                PsStatus.BLOCK_LOADING) {
                                              return Shimmer.fromColors(
                                                  baseColor: PsColors.grey,
                    ...
                    child: (itemProvider.itemList.data != null &&
                        ...
                        ? Column(children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Text(
                                Utils.getString(context,
                                    'dashboard__promotion_item_description'),
                                textAlign: TextAlign.start,
                                style: Theme.of(context).textTheme.bodyText1,
                              ),
                            ),
                        ...
                        children: <Widget>[
                          ...
                          PsTextFieldWidgetWithIcon(
                            hintText: Utils.getString(
                                context, 'dashboard__search_keyword'),
                            textEditingController:
                            ...
                            viewAllClicked: () {
                              Navigator.pushNamed(
                                  ...
                                  arguments: CityIntentHolder(
                                      appBarTitle: Utils.getString(
                                          context, 'dashboard__popular_city'),
                                      cityParameterHolder: CityParameterHolder()
                                          .getPopularCities()));
                            },
                          ),
                          Container(
                            ...
                            child: Text(
                              Utils.getString(context,
                                  'dashboard__popular_city_description'),
                              textAlign: TextAlign.start,
                              style: Theme.of(context).textTheme.bodyText1,
                            ),
                          ),
