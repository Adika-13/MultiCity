  ...
  Widget build(BuildContext context) {
    ...
    return SliverToBoxAdapter(
        child: ChangeNotifierProvider<DisabledItemProvider>(
            ...
            child: Consumer<DisabledItemProvider>(builder: (BuildContext context,
                DisabledItemProvider itemProvider, Widget child) {
              return AnimatedBuilder(
                  animation: widget.animationController,
                  child: (itemProvider.itemList.data != null &&
                          itemProvider.itemList.data.isNotEmpty)
  ...
  Widget build(BuildContext context) {
    ...
    return SliverToBoxAdapter(
        child: ChangeNotifierProvider<RejectedItemProvider>(
            ...
            child: Consumer<RejectedItemProvider>(builder: (BuildContext context,
                RejectedItemProvider itemProvider, Widget child) {
              return AnimatedBuilder(
                  animation: widget.animationController,
                  child: (itemProvider.itemList.data != null &&
                          itemProvider.itemList.data.isNotEmpty)
