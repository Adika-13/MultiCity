...
import 'package:fluttermulticity/provider/comment/comment_detail_provider.dart';
...
import 'package:fluttermulticity/viewobject/holder/comment_detail_holder.dart';
...
class CommentDetailListView extends StatefulWidget {
  const CommentDetailListView(
      {Key key, @required this.commentHeader, @required this.cityId})
      : super(key: key);
                        ...
                        if (await Utils.checkInternetConnectivity()) {
                          Utils.navigateOnUserVerificationView(
                            ...
                            final CommentDetailParameterHolder
                              ...
                              cityId: widget.provider.psValueHolder.cityId,
